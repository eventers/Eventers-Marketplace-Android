...
import com.eventersapp.consumer.databinding.FragmentBuyEventBinding
import com.eventersapp.consumer.ui.adapter.CustomAdapterBuyEvent
import com.eventersapp.consumer.ui.viewmodel.BuyEventViewModel
import com.eventersapp.consumer.ui.viewmodelfactory.BuyEventViewModelFactory
import com.eventersapp.consumer.util.*
import com.eventersapp.consumer.util.AppConstants.BUY_TICKET
import com.eventersapp.consumer.util.AppConstants.RESELL_BUY_TICKET
...
class BuyEventFragment : Fragment(), KodeinAware {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        allEvent =
            requireArguments().getSerializable("all_event_data") as AllEventListResponse.Data
        customAdapterBuyEvent = CustomAdapterBuyEvent(this)
        getUserInfo(allEvent)
    ...
    private fun getUserInfo(allEvent: AllEventListResponse.Data) {
        val userData = AppUtils.getUserPreference(requireContext())
        viewModel.getUserInfo(allEvent, userData, requireContext().deviceId())
    }
