...
import com.eventersapp.consumer.data.model.VerifiedNumberPostBody
import com.eventersapp.consumer.data.model.VerifiedNumberResponse
...
class PhoneOTPViewModel(private val repository: PhoneOTPRepository) : ViewModel() {
    ...
    fun getDeviceInfo(id: String, modelName: String) {
        deviceId = id
